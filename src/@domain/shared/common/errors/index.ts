export const ErrorMessages = {
  BUDGET_DESCRIPTION_LENGHT: 'Invalid description: lenght min 1 and max length 30',
  BUDGET_PORCENTAGE_INVALID_VALUE: 'Invalid Range Value',
  BUDGET_INVALID_DESCRIPTION_LENGHT: 'Invalid description: lenght min 1 and max length 30',
